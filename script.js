const tableData = [
    ...
    { semester: "Third Year, First Semester", courses: [
        { course: "PROEL2", description: "Professional Elective 2", unit: 3.0, grade: "", remarks: "In Progress", year: "First Semester A.Y 2024-2025" },
        { course: "WEBTEC", description: "Web Technology	", unit: 3.0, grade: "", remarks: "In Progress", year: "First Semester A.Y 2024-2025" },
        { course: "MOBAPP", description: "Mobile Application", unit: 3.0, grade: "", remarks: "In Progress", year: "First Semester A.Y 2024-2025" },
        { course: "SYSINT", description: "Systems Integration and Architecture", unit: 3.0, grade: "", remarks: "In Progress", year: "First Semester A.Y 2024-2025" },
        { course: "RESMET", description: "Research Methods in IT	", unit: 3.0, grade: "", remarks: "In Progress", year: "First Semester A.Y 2024-2025" },
        { course: "SOFENG", description: "Software Engineering	", unit: 3.0, grade: "", remarks: "In Progress", year: "First Semester A.Y 2024-2025" }
    ]},
    { semester: "Third Year, Second Semester", courses: [
        { course: "ARTINT", description: "Artificial Intelligence", unit: 3.0, grade: "", remarks: "", year: "Second Semester A.Y 2024-2025" },
        { course: "CLOUDC", description: "Cloud Computing", unit: 3.0, grade: "", remarks: "", year: "Second Semester A.Y 2024-2025" },
        { course: "INFSYS", description: "Information Systems", unit: 3.0, grade: "", remarks: "", year: "Second Semester A.Y 2024-2025" },
        { course: "CAPST1", description: "Capstone Project 1", unit: 3.0, grade: "", remarks: "", year: "Second Semester A.Y 2024-2025" },
        { course: "MATH03", description: "Numerical Analysis", unit: 3.0, grade: "", remarks: "", year: "Second Semester A.Y 2024-2025" }
    ]},
    { semester: "Fourth Year, First Semester", courses: [
        { course: "CYBER", description: "Cybersecurity", unit: 3.0, grade: "", remarks: "", year: "First Semester A.Y 2025-2026" },
        { course: "MATH04", description: "Operations Research", unit: 3.0, grade: "", remarks: "", year: "First Semester A.Y 2025-2026" },
        { course: "SYSDEV", description: "Systems Development and Maintenance", unit: 3.0, grade: "", remarks: "", year: "First Semester A.Y 2025-2026" },
        { course: "ETHICS", description: "Professional Ethics", unit: 3.0, grade: "", remarks: "", year: "First Semester A.Y 2025-2026" },
        { course: "CAPST2", description: "Capstone Project 2", unit: 3.0, grade: "", remarks: "", year: "First Semester A.Y 2025-2026" }
    ]},
    { semester: "Fourth Year, Second Semester", courses: [
        { course: "PHIHIS", description: "Readings in Philippine History", unit: 3.0, grade: "", remarks: "", year: "Second Semester A.Y 2025-2026" },
        { course: "PLATEC", description: "Platform Technologies", unit: 3.0, grade: "", remarks: "", year: "Second Semester A.Y 2025-2026" },
        { course: "BUSANA", description: "Business Analytics", unit: 6.0, grade: "", remarks: "", year: "Second Semester A.Y 2025-2026" },
        { course: "ITPRA2", description: "IT Practicum 2 (250 Hours)", unit: 3.0, grade: "", remarks: "", year: "Second Semester A.Y 2025-2026" },
        { course: "ETHICS", description: "Ethics", unit: 3.0, grade: "", remarks: "", year: "Second Semester A.Y 2025-2026" }
    ]}
];
